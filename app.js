...
var generateRtmToken = function(req, resp) {
    ...
    var key = RtmTokenBuilder.buildToken(appID, appCertificate, account, role, privilegeExpiredTs);
...
var getServer  = function(req, resp) {
    return resp.json({ 'server_status': 'started.' }).send();
};
